...
const Screen = (props:any) => {
  ...
  const theme = {
    ...
    "hashtags":
    {
      ...
      "#love": {"color": "#3f980b", "sounds": ["Reedy_1_Percussive_4.aif.mp3", "Reedy_1_Percussive_5.aif.mp3"], "pattern": [23, 610], "image": "#ff00f0"},
      ...
      "#prayers": {"color": "#dabc10", "sounds": ["Reedy_2_Long_6.aif.mp3"], "pattern": [55, 233], "image": "#ff00f090"},
      "#support": {"color": "#a90ebe", "sounds": ["Reedy_2_Long.aif.mp3"], "pattern": [89, 987], "image": "#ff00f090"},
      "#health": {"color": "#901aff", "sounds": ["Reedy_2_Long_2.aif.mp3"], "pattern": [23, 233], "image": "#ff00f090"},
      "#justice": {"color": "#ebeeff", "sounds": ["Reedy_2_Long_4.aif.mp3"], "pattern": [23, 1597], "image": "#ff00f090"},
      "#gratitude": {"color": "#ff7429", "sounds": ["Firefly 1.mp3"], "pattern": [55, 1597], "image": "#ff00f090"},
      "#respect": {"color": "#af4bf1", "sounds": ["Firefly 2.mp3", "Reedy_2_Long_1.aif.mp3", "Reedy_2_Long_2.aif.mp3"], "pattern": [23, 610], "image": "#ff00f090"},
      "default": {"color": "#ff00f0", "sounds": ["Firefly 1.mp3", "Reedy_2_Long_3.aif.mp3", "Reedy_2_Long.aif.mp3", "Reedy_2_Long_1.aif.mp3", , "Reedy_2_Long_5.aif.mp3"], "pattern": [2, 987], "image": "#ff00f090"},
    }
  };
