...
const Screen = (props:any) => {
  ...
  const theme = {
    ...
    "hashtags":
    {
      ...
      "#health": {"color": "#901aff", "sounds": ["Organ_bip.7.mp3"], "pattern": [55, 233], "image": "#ff00f090"},
      "#justice": {"color": "#ebeeff", "sounds": ["Organ_bip.7.mp3"], "pattern": [55, 233], "image": "#ff00f090"},
      "#gratitude": {"color": "#ff7429", "sounds": ["Organ_bip.8.mp3"], "pattern": [89, 377], "image": "#ff00f090"},
