            ...
            >
              ...
              >
                {`${(marker.from.position.lat == marker.to.position.lat && marker.from.position.lng == marker.to.position.lng)
                  ? marker.hashTag + " to " + marker.to.fullAddress + " from " + marker.from.fullAddress + "."
                  : marker.hashTag + " to " + marker.to.fullAddress + "."
                  }`}
              </div>
            </InfoWindow>
          ) : null}
      ...
      >
        {activeMarker === marker.from._id ? (
          ...
          >
            ...
            >
              {`${(marker.from.position.lat == marker.to.position.lat && marker.from.position.lng == marker.to.position.lng)
                ? marker.hashTag + " from " + marker.from.fullAddress + " to " + marker.to.fullAddress + "."
                : marker.hashTag + " from " + marker.from.fullAddress + "."
                }`}
            </div>
          </InfoWindow>
        ) : null}
